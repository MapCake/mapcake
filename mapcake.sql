...
--
-- Name: atlases; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--
...
ALTER TABLE public.atlases OWNER TO postgres;
...
--
-- Name: layers_maps; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE layers_maps (
    id integer NOT NULL,
...
ALTER TABLE public.layers_maps OWNER TO postgres;
...
CREATE TABLE sources (
    ...
    abstract text NOT NULL,
    "DDBuser" character varying(128) NOT NULL,
    password character varying(128) NOT NULL,
    type text,
    url text NOT NULL,
    createdby integer,
...
--
-- Data for Name: atlases; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY atlases (id, name, abstract, createdby, created, modified) FROM stdin;
\.
...
22	Can add atlases	8	add_atlases
23	Can change atlases	8	change_atlases
24	Can delete atlases	8	delete_atlases
25	Can add users	9	add_users
26	Can change users	9	change_users
27	Can delete users	9	delete_users
28	Can add groups	10	add_groups
29	Can change groups	10	change_groups
30	Can delete groups	10	delete_groups
31	Can add types	11	add_types
32	Can change types	11	change_types
33	Can delete types	11	delete_types
34	Can add sources	12	add_sources
35	Can change sources	12	change_sources
36	Can delete sources	12	delete_sources
37	Can add layers maps	13	add_layersmaps
38	Can change layers maps	13	change_layersmaps
39	Can delete layers maps	13	delete_layersmaps
40	Can add maps	14	add_maps
41	Can change maps	14	change_maps
42	Can delete maps	14	delete_maps
43	Can add atlases maps	15	add_atlasesmaps
44	Can change atlases maps	15	change_atlasesmaps
45	Can delete atlases maps	15	delete_atlasesmaps
\.
...
1	pbkdf2_sha256$10000$XNWDZibCmldP$xFxla3ompXRaCceQ9gdEKhwWa7sCANU1WYwo0EkGnqk=	2013-10-06 12:54:16.110541+02	t	christian				t	t	2013-10-06 12:52:57.233915+02
\.
...
8	atlases	atlas	atlases
9	users	account	users
10	groups	account	groups
11	types	layers	types
12	sources	layers	sources
13	layers maps	layers	layersmaps
14	maps	map	maps
15	atlases maps	map	atlasesmaps
\.
...
wlsx4ps939t8fdainrxxi13w8165zlog	N2IzYzlhMjFiYWI1ZmIyNmJkMTYzMGEzOWY5YmQ3MzE4ZTE4ZGI3MjqAAn1xAShVEl9hdXRoX3VzZXJfYmFja2VuZHECVSlkamFuZ28uY29udHJpYi5hdXRoLmJhY2tlbmRzLk1vZGVsQmFja2VuZHEDVQ1fYXV0aF91c2VyX2lkcQRLAXUu	2013-10-20 12:54:16.168809+02
\.
...
COPY groups (id, name, modified, created) FROM stdin;
\.
...
--
-- Data for Name: layers_maps; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY layers_maps (id, map_id, source_id) FROM stdin;
\.
...
COPY maps (id, name, abstract, createdby, created, modified) FROM stdin;
\.
...
COPY sources (id, titre, source, abstract, "DDBuser", password, type, url, createdby, creation_date, modification_date) FROM stdin;
1	test					services	http://www.cartociudad.es/wms/CARTOCIUDAD/CARTOCIUDAD?	\N	2013-10-07 08:53:29.82582+02	2013-10-07 08:53:29.825888+02
2	test2	DivisionTerritorial	cesci est le résume			services	http://www.cartociudad.es/wms/CARTOCIUDAD/CARTOCIUDAD?	\N	2013-10-08 08:41:38.493725+02	2013-10-08 08:41:38.493765+02
\.
...
COPY users (id, username, name, surname, email, password, group_id, created, modified) FROM stdin;
\.


--
-- Name: atlases_name_key; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY atlases
    ADD CONSTRAINT atlases_name_key UNIQUE (name);


--
-- Name: atlases_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--
...
--
-- Name: layers_maps_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY layers_maps
    ADD CONSTRAINT layers_maps_pkey PRIMARY KEY (id);


--
-- Name: maps_name_key; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--
...
--
-- Name: sources_titre_key; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY sources
    ADD CONSTRAINT sources_titre_key UNIQUE (titre);
...
--
-- Name: atlases_createdby; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE INDEX atlases_createdby ON atlases USING btree (createdby);


--
-- Name: atlases_name_like; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE INDEX atlases_name_like ON atlases USING btree (name varchar_pattern_ops);
...
--
-- Name: layers_maps_map_id; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE INDEX layers_maps_map_id ON layers_maps USING btree (map_id);


--
-- Name: layers_maps_source_id; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE INDEX layers_maps_source_id ON layers_maps USING btree (source_id);


--
-- Name: maps_createdby; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE INDEX maps_createdby ON maps USING btree (createdby);


--
-- Name: maps_name_like; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE INDEX maps_name_like ON maps USING btree (name varchar_pattern_ops);


--
-- Name: sources_createdby; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE INDEX sources_createdby ON sources USING btree (createdby);


--
-- Name: sources_titre_like; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--

CREATE INDEX sources_titre_like ON sources USING btree (titre varchar_pattern_ops);


--
-- Name: users_username_like; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--
...
--
-- Name: createdby_refs_id_f220f48c; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY atlases
    ADD CONSTRAINT createdby_refs_id_f220f48c FOREIGN KEY (createdby) REFERENCES users(id) DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: layers_maps_source_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY layers_maps
    ADD CONSTRAINT layers_maps_source_id_fkey FOREIGN KEY (source_id) REFERENCES sources(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: map_id_refs_id_48b80e08; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY layers_maps
    ADD CONSTRAINT map_id_refs_id_48b80e08 FOREIGN KEY (map_id) REFERENCES maps(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: maps_createdby_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY maps
    ADD CONSTRAINT maps_createdby_fkey FOREIGN KEY (createdby) REFERENCES users(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: sources_createdby_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY sources
    ADD CONSTRAINT sources_createdby_fkey FOREIGN KEY (createdby) REFERENCES users(id) DEFERRABLE INITIALLY DEFERRED;
